    ...
    <Popover align="end" side="top" sideOffset={32} onOpenChange={setIsEditMode} open={isEditMode}>
      <div className="rounded-lg bg-zinc-950 border border-zinc-900 shadow-zinc-900/40 shadow-2xl w-72 h-fit">
        <div className="bg-zinc-900/50 rounded-lg">
          ...
          <textarea
            className="w-full min-h-24 max-h-72 text-zinc-300 p-2 outline-none ring-0 ring-zinc-600 focus:ring-2 custom-scrollbar overflow-x-hidden placeholder:text-center placeholder:text-sm placeholder:font-sans placeholder:text-zinc-600 field-sizing-content bg-transparent resize-none"
